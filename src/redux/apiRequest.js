...
export const LoginGoogle = async (id_token, dispatch, navigate) => {
    dispatch(handleLoading())
    try {
        const res = await axios.post(`${genURL('/v1/auth/google_login')}`, {id_token})
        dispatch(loginSuccess(res.data))
        dispatch(handleRemove())
        navigate("/")
        return res.data
...
export const LoginFacebook = async (access_token, userID, dispatch, navigate) => {
    dispatch(handleLoading())
    try {
        const res = await axios.post(`${genURL('/v1/auth/facebook_login')}`, {access_token, userID})
        dispatch(loginSuccess(res.data))
        dispatch(handleRemove())
        navigate("/")
        return res.data
...
export const AddCard = async (card, accessToken, dispatch) => {
    try {
        ...
        dispatch(handleRemove())
        dispatch(showToast({msg:"Đăng xuất thành công", success: true}))
        return res.data
    } catch (error) {
    }
}
export const getCardById = async (dispatch, card, page, limit) => {
    try {
        dispatch(handleLoading())
        const res = await axios.get(`${genURL(`/v1/card/${card}`, {page: page, limit: limit})}`)
        dispatch(handleRemove())
        return res.data
    } catch (error) {
        dispatch(handleRemove())
...
export const savedCard = async (dispatch, cardId, accessToken) => {
    try {
        const res = await axiosJWT.post(`${genURL(`/v1/card/${cardId}`)}`,{}, {
            headers: {token: `Bearer ${accessToken}`},
        })
...
export const GetLibrary = async (accessToken, dispatch, limit) => {
    try {
        dispatch(handleLoading())
        const res = await axiosJWT.get(`${genURL('/v1/card/library', {limit: limit})}`,{
            headers: {token: `Bearer ${accessToken}`}
        })
        dispatch(handleRemove())
        return res.data
...
export const GetTranslate = async (translate) => {
    try {
        const res = await axiosJWT.get(`https://api.mymemory.translated.net/get?q=${translate}&langpair=en|vi`)
...
export const UpdateCard = async (card, cardId, accessToken, userId, dispatch) => {
    try {
        const res = await axiosJWT.patch(`${genURL(`/v1/card/${cardId}`)}`, {card, userId}, {
            headers: {token: `Bearer ${accessToken}`},
        })
...
export const GetQuestion = async (dispatch, cardId, limit) => {
    try {
        dispatch(handleLoading())
        const res = await axios.get(`${genURL(`/v1/card/question/${cardId}`, {limit: limit})}`)
        dispatch(handleRemove())
        return res.data
    } catch (error) {
        dispatch(handleRemove())
...
export const GetLearn = async (dispatch, cardId, user, limit) => {
    try {
        dispatch(handleLoading())
        const res = await axios.get(`${genURL(`/v1/card/learn/${cardId}`, {limit: limit})}`, { params: { user } })
        dispatch(handleRemove())
        return res.data
    } catch (error) {
        dispatch(handleRemove())
...
export const GetMarkLearn = async (dispatch, cardId, ques, user) => {
    try {
        dispatch(handleLoading())
        const res = await axiosJWT.post(`${genURL(`/v1/card/learn/${cardId}`)}`, {ques, user})
        dispatch(handleRemove())
        return res.data
    } catch (error) {
        dispatch(handleRemove())
...
export const GetListen = async (dispatch, cardId, user, limit) => {
    try {
        dispatch(handleLoading())
        const res = await axios.get(`${genURL(`/v1/card/listen/${cardId}`, {limit: limit})}`, { params: { user } })
        dispatch(handleRemove())
        return res.data
    } catch (error) {
        dispatch(handleRemove())
...
export const GetMarkListen = async (dispatch, cardId, ques, user) => {
    try {
        dispatch(handleLoading())
        const res = await axiosJWT.post(`${genURL(`/v1/card/listen/${cardId}`)}`, {ques, user})
        dispatch(handleRemove())
        return res.data
    } catch (error) {
        dispatch(handleRemove())
...
export const GetWrite = async (dispatch, cardId, user, limit) => {
    try {
        dispatch(handleLoading())
        const res = await axios.get(`${genURL(`/v1/card/write/${cardId}`, {limit: limit})}`, { params: { user } })
        dispatch(handleRemove())
        return res.data
    } catch (error) {
        dispatch(handleRemove())
...
export const GetMarkWrite = async (dispatch, cardId, ques, user) => {
    try {
        dispatch(handleLoading())
        const res = await axiosJWT.post(`${genURL(`/v1/card/write/${cardId}`)}`, {ques, user})
        dispatch(handleRemove())
        return res.data
    } catch (error) {
        dispatch(handleRemove())
...
export const GetMatchCard = async (dispatch, cardId, user, limit) => {
    try {
        dispatch(handleLoading())
        const res = await axios.get(`${genURL(`/v1/card/match/${cardId}`, {limit: limit})}`, { params: { user } })
        dispatch(handleRemove())
        return res.data
    } catch (error) {
        dispatch(handleRemove())
...
export const UpdateMardMatchCard = async (cardId, user, terms) => {
    try {
        const res = await axiosJWT.post(`${genURL(`/v1/card/match/${cardId}`)}`, {user, terms})
        return res.data
    } catch (error) {
    }
}
...
export const GetTest = async (dispatch, cardId, user, limit) => {
    try {
        dispatch(handleLoading())
        const res = await axios.get(`${genURL(`/v1/card/test/${cardId}`, {limit: limit})}`, { params: { user } })
        dispatch(handleRemove())
        return res.data
    } catch (error) {
        dispatch(handleRemove())
...
export const GetMarkTest = async (dispatch, cardId, ques, user) => {
    try {
        dispatch(handleLoading())
        const res = await axiosJWT.post(`${genURL(`/v1/card/test/${cardId}`)}`, {ques, user})
        dispatch(handleRemove())
        return res.data
    } catch (error) {
        dispatch(handleRemove())
...
export const GetSongIndex = async (keyword) => {
    try {
        const res = await axios.get(`${genURL(`/v1/zing/search?keyword=${keyword}`)}`)
        return res.data
    } catch (error) {
    }
}
...
export const GetSong = async (index) => {
    try {
        const res = await axios.get(`${URL}/song?id=${index}`)
        return res.data
    } catch (error) {
...
export const GetLyric = async (index, dispatch) => {
    try {
        dispatch(handleLoading())
        const res = await axios.get(`${URL}/lyric?id=${index}`)
        dispatch(handleRemove())
        return res.data
    } catch (error) {
        dispatch(handleRemove())
...
export const RateCard = async (cardId, rateNum, accessToken, dispatch) => {
    try {
        const res = await axiosJWT.post(`${genURL(`/v1/card/rate/${cardId}`)}`, {rateNum}, {
            headers: {token: `Bearer ${accessToken}`}})
...
export const GetListCard = async (dispatch, q, page = 1, limit = 8, userId = '') => {
    try {
        dispatch(handleLoading())
        const res = await axios.get(`${genURL('/v1/card', {q: q, page: page, limit: limit})}`, { params: { userId } })
        dispatch(handleRemove())
        return res.data
    } catch (error) {
        dispatch(handleRemove())
...
export const GetHome = async (dispatch, limit, userId) => {
    try {
        dispatch(handleLoading())
        const res = await axios.get(`${genURL('/v1/card', {limit: limit})}`, { params: { userId } })
        dispatch(handleRemove())
        return res.data
    } catch (error) {
        dispatch(handleRemove())
...
export const UpdateUser = async (userId, type, data, accessToken, dispatch) => {
    try {
        const res = await axios.put(`${genURL(`/v1/auth/user/${userId}`)}`, {type, data}, {
            headers: {token: `Bearer ${accessToken}`}})
            dispatch(showToast({msg: "Update thành công", success: true}))
        return res.data
    } catch (error) {
...
export const CreateNotifi = async (userId, content, accessToken) => {
    try {
        const res = await axiosJWT.post(`${genURL('/v1/notification')}`, {userId, content}, {
            headers: {token: `Bearer ${accessToken}`}})
        return res.data
    } catch (error) {
    }
...
export const ReadNotifi = async (notifiId, accessToken) => {
    try {
        const res = await axiosJWT.patch(`${genURL('/v1/notification')}`, {notifiId}, {
            headers: {token: `Bearer ${accessToken}`}})
        return res.data
    } catch (error) {
    }
