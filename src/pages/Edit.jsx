...
useEffect(() => {
  ...
  const handleUpdate = async() => {
    ...
    if(newCard.term.length < 2){
        ...
        const res = await UpdateCard(newCard, cardId, accessToken, userId, dispatch)
  ...
  return (
    ...
    <div className="edit">
      ...
      <div className="edit__header">
        <div className="edit__header__left">
            <div className="edit__header__input">
                <div className="edit__header__input__wrap">
                    <textarea maxLength="30" placeholder='Nhập tiêu đề...' onChange={(e) => setTitle(e.target.value)} value={title}>
                    </textarea>
            ...
            <div className="edit__header__input">
                <div className="edit__header__input__wrap">
                    <textarea className='edit__header__input__wrap__des' maxLength="200" placeholder='Thêm mô tả' onChange={(e) => setDescription(e.target.value)} value={description} rows={4}>
                    </textarea>
        ...
        <div className="edit__header__right">
            <div className="edit__header__right__item">
                <div className="edit__header__right__item__txt">
                    Ảnh nền
                </div>
            ...
            <div className="edit__header__right__item">
                <div className='checkbox__private'>
                    <div className="checkbox__private__txt"><span>Share</span> <input type="checkbox" onClick={e => setShare(e.target.checked)} value={share} checked={share}></input></div>
                </div>
            </div>
        </div>
      </div>
      <div className="edit__term">
        ...
        {
            total > page && <div className="load-more">
