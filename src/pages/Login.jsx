        ...
        <>
          {
            ...
            <form className="form" onSubmit={handleSubmit}>
              <h3>Đăng nhập</h3>
              <SocialLogin />
              <input type="text" name='username' placeholder='Nhập tài khoản' className='box' value={values.username} onChange={handleChange}/>
              ...
              <p className='login__footer'>Bạn chưa có tài khoản?<Link to='/register'>Đăng ký ngay</Link></p>
          </form> : <ForgotPassword setForgot={setForgot}/>
          }
        </>
      }
      {
