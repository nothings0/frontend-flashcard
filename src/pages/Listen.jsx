...
const Listen = () => {
  ...
  return (
    ...
    <div className="listen">
      <Search/>
      <HeaderPrimary value={index} length={data?.length} round={round} title="Luyện nghe"/>
      <ListenCpn subType={true} handleQues={handleQues} data={data[index]} setAnswer={setAnswer} answer={answer} isResult={isResult} handleIndex={handleIndex} result={result}/>
      {
        modalOpen && <Modal
        modalOpen={modalOpen}
      >
