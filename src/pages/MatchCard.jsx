...
import { GetMatchCard, UpdateMardMatchCard } from '../redux/apiRequest'
      ...
      <div className="cards">
        {
          terms && terms.map((item, index) => (
            <div className="cardz" key={index} onClick={e => flipCard(e, setModalType, setModalOpen)}>
      ...
      </div>
      {
        modalOpen && modalType === 1 && <Modal
          ...
          >
            ...
            <ModalBody>
              {
                data?.total > 1 ? <p>Phải có ít nhất 8 thuật ngữ để bắt đầu học tập</p>
